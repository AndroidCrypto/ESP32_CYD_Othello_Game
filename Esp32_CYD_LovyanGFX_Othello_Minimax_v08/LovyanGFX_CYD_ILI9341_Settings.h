// Source: https://github.com/lovyan03/LovyanGFX/issues/546#issuecomment-2066749053
...
public:
  LGFX(void) {
    {                                     // Set up bus control.
      ...
      cfg.freq_write = 55000000;          // SPI clock for transmit (max 80MHz, round 80MHz to integer divisor)
